...
namespace KamiModpackBuilder.Sm4shMusic.Objects
{
    public class UISoundDBFile
    {
        ...
        public UISoundDBFile(SmashProjectManager projectManager, SoundEntryCollection sEntryCollection, string path)
        {
            ...
            if (!File.Exists(uiSoundDBFile)) uiSoundDBFile = projectManager.ExtractResource(path, PathHelper.FolderTemp);
        ...
        public void BuildFile()
        {
            ...
            foreach (ResourceCollection resCol in _Project.ResourceDataCollection)
                savePaths.Add(PathHelper.GetEditorModsFolder() + _Path.Replace('/', Path.DirectorySeparatorChar).Replace("data", resCol.PartitionName));
