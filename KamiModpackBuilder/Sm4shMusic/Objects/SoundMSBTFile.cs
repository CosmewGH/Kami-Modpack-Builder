...
namespace KamiModpackBuilder.Sm4shMusic.Objects
{
    public class SoundMSBTFile
    {
        ...
        public SoundMSBTFile(SmashProjectManager projectManager, SoundEntryCollection sEntryCollection, string path)
        {
            ...
            if (!File.Exists(soundMSBTFile)) soundMSBTFile = projectManager.ExtractResource(path, PathHelper.FolderTemp);
        ...
        {
            string savePath = PathHelper.GetEditorModsFolder() + _Path.Replace('/', Path.DirectorySeparatorChar);
