...
namespace KamiModpackBuilder.Sm4shMusic.Globals
{
    public class Strings
    {
        ...
        public const string INFO_COMPILED = "The modifications were successfully saved in the workspace editor mods folder. If you wish to restore the original file, simply remove 'sound/config/bgm_property.mpb', 'param/ui/ui_sound_db.bin', 'sound/config/bgm_mymusic.mmb' and 'ui/message/sound.msbt' from the workspace editor mods folder.";
