...
namespace KamiModpackBuilder.DB
{
    public class IconsDB
    {
        ...
        #region Main Methods
        internal static void InitializeIconsDB(int gameVersion, bool isSwitch)
        {
            if (isSwitch)
                InitializeIconsSwitchDB(gameVersion);
            else
        ...
        private static void InitializeIconsSwitchDB(int gameVersion)
        {
            throw new Exception(string.Format("IconsDB: Version {0} for Ultimate not supported.", gameVersion));
        }
        #endregion
